package com.example.repositoryworkmanager.viewmodels
...
import com.example.repositoryworkmanager.network.asDomainModel
...
class DevByteViewModel(application: Application) : AndroidViewModel(application) {
    ...
    //Variable for holding a LiveData list of videos from the repository.
    ...
    */
    ...
    /*private fun refreshDataFromNetwork() = viewModelScope.launch {
        try {
            ...
            //  delay(2000) // Simulating the progress bar
